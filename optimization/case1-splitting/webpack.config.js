...
let config = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({ filename: `entry1.html`, template: "./src/entry1/index.html", chunks: ["entry1", "default", "vendors","runtime"] }),
        new HtmlWebpackPlugin({ filename: `entry2.html`, template: "./src/entry2/index.html", chunks: ["entry2", "default", "vendors","runtime"] }),
